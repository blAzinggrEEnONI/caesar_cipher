...
class CipherService:
    ...
    def decrypt_text(
        ...
        """
        Decrypt ciphertext using the Caesar cipher algorithm.

        This operation reverses the encryption process by shifting characters
        backwards using the corresponding shift value.
